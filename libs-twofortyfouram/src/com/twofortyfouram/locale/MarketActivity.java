...
/**
 * Provides a simple dialog UI for the user to understand what a plug-in is when tapping on the "open" button from Google Play.
 */
public final class MarketActivity extends Activity implements DialogInterface.OnDismissListener
{
    ...
    /**
     * URI to Locale in the web version of Google Play.
     * <p>
     * This String requires two string formats be inserted: 1. The package name of Locale 2. The package name of the plug-in.
     */
    private static final String MARKET_WEB_URI = "http://play.google.com/store/apps/details?id=%s&referrer=utm_source=%s&utm_medium=app&utm_campaign=plugin"; //$NON-NLS-1$
    ...
    public void onCreate(final Bundle savedInstanceState)
    {
        ...
        /*
         * Hack: the ContentView must have a layout for a dialog to be displayed. Setting the layout to then be hidden has the
         * desired effect.
         */
